...
namespace IngameDebugConsole
{
    ...
    public static class DebugLogConsole
    {
        ...
        public static void SearchAssemblyForConsoleMethods(Assembly assembly)
        {
            ...
            {
                ModMain.Log.Error("Couldn't search assembly for [ConsoleMethod] attributes: " + assembly.GetName().Name + "\n" + e.ToString());
            }
        }
        ...
        public static void LogAllCommands(TextWriter o)
        {
            int length = 25;
            for (int i = 0; i < methods.Count; i++)
            {
            ...
            o.WriteLine(stringBuilder.ToString());
        }

        // Logs the list of available commands that are either equal to commandName or contain commandName as substring
        public static void LogAllCommandsWithName(TextWriter writer, string commandName)
        {
            ...
            if (matchingMethods.Count == 0)
                writer.WriteLine(string.Concat("ERROR: can't find command '", commandName, "'"));
            else
            {
        ...
        public static void AddCustomParameterType(Type type, ParseFunction parseFunction, string typeReadableName = null)
        {
            if (type == null)
            {
                ModMain.Log.Error("Parameter type can't be null!");
                return;
            }
            else if (parseFunction == null)
            {
                ModMain.Log.Error("Parameter parseFunction can't be null!");
                return;
            }
        ...
        public static void AddCommandInstance(string command, string description, string methodName, object instance, params string[] parameterNames)
        {
            if (instance == null)
            {
                ModMain.Log.Error("Instance can't be null!");
                return;
            }
        ...
        public static void AddCommand(string command, string description, Action<TextWriter> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1>(string command, string description, Action<TextWriter, T1> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1>(string command, string description, Func<TextWriter, T1> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2>(string command, string description, Action<TextWriter, T1, T2> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2>(string command, string description, Func<TextWriter, T1, T2> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2, T3>(string command, string description, Action<TextWriter, T1, T2, T3> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2, T3>(string command, string description, Func<TextWriter, T1, T2, T3> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2, T3, T4>(string command, string description, Action<TextWriter, T1, T2, T3, T4> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2, T3, T4>(string command, string description, Func<TextWriter, T1, T2, T3, T4> method) { AddCommand(command, description, method.Method, method.Target, null); }
        public static void AddCommand<T1, T2, T3, T4, T5>(string command, string description, Func<TextWriter, T1, T2, T3, T4, T5> method) { AddCommand(command, description, method.Method, method.Target, null); }
        ...
        public static void AddCommand<T1>(string command, string description, Action<TextWriter, T1> method, string parameterName) { AddCommand(command, description, method.Method, method.Target, new string[1] { parameterName }); }
        public static void AddCommand<T1, T2>(string command, string description, Action<TextWriter, T1, T2> method, string parameterName1, string parameterName2) { AddCommand(command, description, method.Method, method.Target, new string[2] { parameterName1, parameterName2 }); }
        public static void AddCommand<T1, T2>(string command, string description, Func<TextWriter, T1, T2> method, string parameterName) { AddCommand(command, description, method.Method, method.Target, new string[1] { parameterName }); }
        public static void AddCommand<T1, T2, T3>(string command, string description, Action<TextWriter, T1, T2, T3> method, string parameterName1, string parameterName2, string parameterName3) { AddCommand(command, description, method.Method, method.Target, new string[3] { parameterName1, parameterName2, parameterName3 }); }
        public static void AddCommand<T1, T2, T3>(string command, string description, Func<TextWriter, T1, T2, T3> method, string parameterName1, string parameterName2) { AddCommand(command, description, method.Method, method.Target, new string[2] { parameterName1, parameterName2 }); }
        public static void AddCommand<T1, T2, T3, T4>(string command, string description, Action<TextWriter, T1, T2, T3, T4> method, string parameterName1, string parameterName2, string parameterName3, string parameterName4) { AddCommand(command, description, method.Method, method.Target, new string[4] { parameterName1, parameterName2, parameterName3, parameterName4 }); }
        public static void AddCommand<T1, T2, T3, T4>(string command, string description, Func<TextWriter, T1, T2, T3, T4> method, string parameterName1, string parameterName2, string parameterName3) { AddCommand(command, description, method.Method, method.Target, new string[3] { parameterName1, parameterName2, parameterName3 }); }
        public static void AddCommand<T1, T2, T3, T4, T5>(string command, string description, Func<TextWriter, T1, T2, T3, T4, T5> method, string parameterName1, string parameterName2, string parameterName3, string parameterName4) { AddCommand(command, description, method.Method, method.Target, new string[4] { parameterName1, parameterName2, parameterName3, parameterName4 }); }
        ...
        private static void AddCommand(string command, string description, string methodName, Type ownerType, object instance, string[] parameterNames)
        {
            ...
            MethodInfo method = ownerType.GetMethod(methodName, BindingFlags.Public | BindingFlags.NonPublic | 
                (instance != null ? BindingFlags.Instance : BindingFlags.Static));
            if (method == null)
            {
                ModMain.Log.Error(methodName + " does not exist in " + ownerType);
                return;
            }
        ...
        internal static void AddCommand(string command, string description, MethodInfo method, object instance, string[] parameterNames)
        {
            ...
            {
                ModMain.Log.Error("Command name can't be empty!");
                return;
            }
            ...
            if (command.Contains(' '))
            {
                ModMain.Log.Error("Command name can't contain whitespace: " + command);
                return;
            }
            ...
            for (int i = 1; i < parameters.Length; i++)
            {
                ...
                {
                    ModMain.Log.Error("Command can't have 'out' or 'ref' parameters");
                    return;
                }
        ...
        public static void ExecuteCommand(string command, TextWriter writer)
        {
            if (command == null)
                return;
            ...
            if (matchingMethods.Count == 0)
            {
                ...
                if (matchingMethods.Count == 0)
                    writer.WriteLine(string.Concat("ERROR: can't find command '", _command, "'"));
                else
                {
            ...
            if (methodToExecute == null)
                writer.WriteLine(!string.IsNullOrEmpty(errorMessage) ? errorMessage : "ERROR: something went wrong");
            else
            {
                // Execute the method associated with the command
                object result = methodToExecute.method.Invoke(methodToExecute.instance, [writer, .. parameters]);
                if (methodToExecute.method.ReturnType != typeof(void))
                {
                    // Print the returned value to the console
                    if (result == null || result.Equals(null))
                        writer.WriteLine("Returned: null");
                    else
                        writer.WriteLine("Returned: " + result.ToString());
                }
        ...
        public static bool IsSupportedArrayType(Type type)
        {
            ...
            return parseFunctions.ContainsKey(type) || type.IsEnum;
        }
        ...
        public static bool ParseEnum(string input, Type enumType, out object output)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                if (orIndex < 0)
                    enumStr = input[i..(andIndex < 0 ? input.Length : andIndex)].Trim();
                else
                    enumStr = input[i..(andIndex < 0 ? orIndex : Math.Min(andIndex, orIndex))].Trim();
